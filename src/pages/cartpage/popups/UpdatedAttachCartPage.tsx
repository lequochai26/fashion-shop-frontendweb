...
export default function UpdatedAttachCartPage({ cart, onCancel, onSubmit }: AttachCartPageParam) {
    // States:
                                ...
                                <div className="flex flex-row justify-start items-stretch border border-black border-solid">
                                    ...
                                    <div className="mr-5 flex flex-col justify-center">
                                        <img
                                            alt="Item's avatar"
                                            src={
                                                slot.cartItem.item?.avatar
                                                &&
                                                makeAPIUrl(slot.cartItem.item.avatar)
                                            }
                                            className="w-28 h-28"
                                        />
                                    </div>
                                    ...
                                    <div className="flex-1 flex flex-col justify-between text-lg my-2">
                                        ...
                                        <div>
                                            <b>Đơn giá:</b> {
                                                slot.cartItem.item?.getPriceVND(slot.cartItem.metadata)
                                            }
                                        </div>

                                        {/* Total price */}
                                        <div>
                                            <b>Giá:</b> { slot.cartItem.getTotalPriceVND() }
                                        </div>
